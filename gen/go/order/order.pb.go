...
import (
	common "github.com/fiqriardiansyah/shopping-proto/gen/go/common"
...
const file_order_order_proto_rawDesc = "" +
	"\n" +
	"\x11order/order.proto\x12\x05order\x1a\x13common/common.proto\"/\n" +
	"\x14GetUserOrdersRequest\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\">\n" +
	"\x15GetUserOrdersResponse\x12%\n" +
	"\x06orders\x18\x01 \x03(\v2\r.common.OrderR\x06orders2Z\n" +
	"\fOrderService\x12J\n" +
	"\rGetUserOrders\x12\x1b.order.GetUserOrdersRequest\x1a\x1c.order.GetUserOrdersResponseB@Z>github.com/fiqriardiansyah/shopping-proto/gen/go/order;orderpbb\x06proto3"
...
var file_order_order_proto_goTypes = []any{
	(*GetUserOrdersRequest)(nil),  // 0: order.GetUserOrdersRequest
	(*GetUserOrdersResponse)(nil), // 1: order.GetUserOrdersResponse
	(*common.Order)(nil),          // 2: common.Order
}
var file_order_order_proto_depIdxs = []int32{
	2, // 0: order.GetUserOrdersResponse.orders:type_name -> common.Order
	0, // 1: order.OrderService.GetUserOrders:input_type -> order.GetUserOrdersRequest
	1, // 2: order.OrderService.GetUserOrders:output_type -> order.GetUserOrdersResponse
